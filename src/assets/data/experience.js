        ...
        projects: [
            {
                ...
                tools: [{ label: "React", logo: "react.png" }, { label: "Wagtail", logo: "wagtail.png" }, { label: "Django", logo: "django.png" }, { label: "Metabase", logo: "metabase.png" }],
            },
            {
                logo: "smile56.png",
                alt: "Smile56 logo",
                about: "Website development for an organization helping children in foster care in the Morbihan department.",
                tasks: [
                ],
                tools: [{ label: "React", logo: "react.png" }, { label: "Astro", logo: "astro.png" }, { label: "Strapi", logo: "strapi.png" }],
            },
        ], 
    },
    {
        ...
        projects: [
            {
                ...
                about: "Web development for user journeys.",
                tasks: [
                    "Design system setup and maintainance for microservices UI consistency",
                    "Electricity consumption monitoring rework",
                    "HTML to PDF billing templating and export"
                ],
                tools: [{ label: "Vue.js", logo: "vue.png" }, { label: "SCSS", logo: "sass.png" }, { label: "WordPress", logo: "wp.png" }, { label: "D3.js", logo: "d3.png" }, { label: "Testcafé", logo: "testcafe.png" }],
            }
        ], 
    },
    {
